...
insert into tessera (numero, data_emissione, data_scadenza, descrizione_tessera_id, titolare_id, danneggiata, smarrita, restituita) values (2001, '2024-03-01', '2025-03-01', (select id from descrizione_tessera where tipo_tessera = 'FULL'), (select id from dipendentecc where nome = 'Anna' and cognome = 'Bianchi'), false, false, false);
insert into tessera (numero, data_emissione, data_scadenza, descrizione_tessera_id, titolare_id, danneggiata, smarrita, restituita) values (2002, '2025-05-10', '2025-06-10', (select id from descrizione_tessera where tipo_tessera = 'FULL'), (select id from dipendentecc where nome = 'Carlo' and cognome = 'Mancini'), false, false, false);
insert into tessera (numero, data_emissione, data_scadenza, descrizione_tessera_id, titolare_id, danneggiata, smarrita, restituita) values (2003, '2025-04-25', NULL, (select id from descrizione_tessera where tipo_tessera = 'SCALARE'), (select id from dipendentecc where nome = 'Francesca' and cognome = 'Rizzo' ), false, false, false);
